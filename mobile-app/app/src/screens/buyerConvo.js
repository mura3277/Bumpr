...
import { StyleSheet, Button, Dimensions, SafeAreaView, Image, Text, View, ScrollView, TextInput, Alert} from 'react-native';
...
/*
To get the little message symbol, I followed this tutorial: 
https://www.freecodecamp.org/news/design-imessage-like-chat-bubble-react-native/
*/
const SCREEN_HEIGHT = Dimensions.get('window').height
const SCREEN_WIDTH = Dimensions.get('window').width

export default function BuyerConvo({route}) {
    ...
    const conversations = useState([{"postId":120910,"brand":"BMW","model":"7 Series","sellingLoc":"St Andrew's","askingPrice":15000,"Images":["https://upload.wikimedia.org/wikipedia/commons/9/93/2019_BMW_740Li_Automatic_facelift_3.0.jpg","https://www.topgear.com/sites/default/files/cars-car/image/2019/04/bmw_750li_xdrive_19.jpg","https://mediapool.bmwgroup.com/cache/P9/201812/P90333060/P90333060-the-new-bmw-7-series-in-painting-bernina-grey-amber-effect-metallic-with-light-alloy-wheel-styling-7-2250px.jpg"],desc:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.", "messages":[{user:false, msgId: 0, msg:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."},{user:true, msgId: 1, msg:"Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."}, {user:false, msgId: 2, msg:"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."}, {user:false, msgId:3, msg:"Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."}]},
				    ...
				    {"postId":864321,"brand":"Toyota","model":"Camry","sellingLoc":"Dundee","askingPrice":8000,"Images":["https://www.cnet.com/a/img/resize/b9cb3466480927557fb89f3558e9b92acd390508/hub/2021/08/20/257caf0a-f3a2-45db-9c70-d6ed50a85e6f/2021-toyota-camry-trd-ogi-1.jpg?auto=webp&fit=crop&height=675&width=1200"],desc:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.","messages":[{user:true, msgId: 0, msg:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."},{user:false, msgId: 1, msg:"Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."}, {user:false, msgId: 2, msg:"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."}, {user:true, msgId:3, msg:"Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."}]},
				    {"postId":5843124,"brand":"Dodge","model":"Charger","sellingLoc":"Edinburgh","askingPrice":16000,"Images":["https://aeceurope.com/wp-content/uploads/2020-charger-rt-gomango.jpg"],desc:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.","messages":[{user:false, msgId: 0, msg:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."},{user:true, msgId: 1, msg:"Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."}, {user:false, msgId: 2, msg:"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."}, {user:true, msgId:3, msg:"Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."}]},
				    {"postId":9873345,"brand":"BMW","model":"Mini Cooper","sellingLoc":"Aberdeen","askingPrice":20000,"Images":["https://cdn.motor1.com/images/mgl/B36GR/s1/2022-mini-cooper-hardtop-front.jpg"],desc:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.","messages":[{user:false, msgId: 0, msg:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."},{user:true, msgId: 1, msg:"Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."}, {user:false, msgId: 2, msg:"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."}, {user:true, msgId:3, msg:"Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."}]}
				   ]);

    // when you get to this page, load the messages for the convo
    useEffect(() => {
    ...
    // send the message to the backend and update the frontend 
    // with the data sent back
    const sendMessage = () =>
    {
        if(inputText!=""){
            axios.get(baseUrl+`/sendMessage/`+userId+'/'+convoId+'/True/'+inputText)
            .then(res => {
    ...
    // for each message in the array, render it accordingly
    ...
    const backButton = () => {
	if(!pressed){
	    navigation.navigate('BuyerMessages', {email:email});
	}
	else {
	    togglePressed();
	}
    ...
    return (
        ...
        <View>
			...
			<ViewCar style={{zIndex:1000}} isClicked ={pressed} toggle = {togglePressed} carsInfo = {convoData} />
			</View>
		    <View style = {styles.titleView} key={postId}>
			...
			<View style = {{ flex:6,alignItems: 'center', flexDirection:'row'}}>
			    <Text style = {{color: "black", fontSize: scaleFont(convoData.brand.replace(RegExp('RUFUSAPOSTROPHE','g'),"\'")+" "+convoData.model.replace(RegExp('RUFUSAPOSTROPHE','g'),"\'")), fontWeight: "800", padding: 10}}> {convoData.brand.replace(RegExp('RUFUSAPOSTROPHE','g'),"\'")} {convoData.model.replace(RegExp('RUFUSAPOSTROPHE','g'),"\'")} </Text>
			</View>
		    </View>
		</TouchableOpacity>
		    </View>
